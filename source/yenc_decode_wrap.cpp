...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(simple_php_yenc_decode)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(simple_php_yenc_decode)
ZEND_DECLARE_MODULE_GLOBALS(simple_php_yenc_decode)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(simple_php_yenc_decode_globals_id, zend_simple_php_yenc_decode_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(simple_php_yenc_decode_globals_id, zend_simple_php_yenc_decode_globals *, error_code )
#else
#define SWIG_ErrorMsg() (simple_php_yenc_decode_globals.error_msg)
#define SWIG_ErrorCode() (simple_php_yenc_decode_globals.error_code)
#endif
...
static void simple_php_yenc_decode_init_globals(zend_simple_php_yenc_decode_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void simple_php_yenc_decode_destroy_globals(zend_simple_php_yenc_decode_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_simple_php_yenc_decode_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_simple_php_yenc_decode_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "simple_php_yenc_decode"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_simple_php_yenc_decode.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_simple_yenc_decode) {
  ...
  result = simple_yenc_decode(arg1);
...
static zend_function_entry simple_php_yenc_decode_functions[] = {
 SWIG_ZEND_NAMED_FE(simple_yenc_decode,_wrap_simple_yenc_decode,NULL)
 SWIG_ZEND_NAMED_FE(swig_simple_php_yenc_decode_alter_newobject,_wrap_swig_simple_php_yenc_decode_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_simple_php_yenc_decode_get_newobject,_wrap_swig_simple_php_yenc_decode_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry simple_php_yenc_decode_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"simple_php_yenc_decode",
    simple_php_yenc_decode_functions,
    PHP_MINIT(simple_php_yenc_decode),
    PHP_MSHUTDOWN(simple_php_yenc_decode),
    PHP_RINIT(simple_php_yenc_decode),
    PHP_RSHUTDOWN(simple_php_yenc_decode),
    PHP_MINFO(simple_php_yenc_decode),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &simple_php_yenc_decode_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &simple_php_yenc_decode_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(simple_php_yenc_decode)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(simple_php_yenc_decode, simple_php_yenc_decode_init_globals, simple_php_yenc_decode_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(simple_php_yenc_decode_globals_id);
#endif
    return SUCCESS;
}
